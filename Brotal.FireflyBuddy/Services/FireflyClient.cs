...
public sealed class FireflyClient : IFireflyClient, IDisposable, IAsyncDisposable
{
    ...
    public async Task<FireflyContextSnapshot> GetContextAsync(CancellationToken cancellationToken = default)
    {
        lock (_cacheLock)
        {
