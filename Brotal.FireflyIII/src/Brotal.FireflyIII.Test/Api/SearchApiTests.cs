...
namespace Brotal.FireflyIII.Test.Api
{
    ...
    public sealed class SearchApiTests : ApiTestsBase
    {
        ...
        public async Task SearchAccountsAsyncTest()
        {
            string query = default!;
            AccountSearchFieldFilter field = default!;
            ...
            var response = await _instance.SearchAccountsAsync(query, field, xTraceId, limit, page, type);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SearchTransactionsAsyncTest()
        {
            string query = default!;
            Client.Option<Guid> xTraceId = default!;
            Client.Option<int> limit = default!;
            Client.Option<int> page = default!;
            var response = await _instance.SearchTransactionsAsync(query, xTraceId, limit, page);
            var model = response.Ok();
