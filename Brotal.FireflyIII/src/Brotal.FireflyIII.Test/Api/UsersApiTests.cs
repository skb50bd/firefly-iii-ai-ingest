...
namespace Brotal.FireflyIII.Test.Api
{
    ...
    public sealed class UsersApiTests : ApiTestsBase
    {
        ...
        public async Task DeleteUserAsyncTest()
        {
            ...
            await _instance.DeleteUserAsync(id, xTraceId);
        }
        ...
        public async Task GetUserAsyncTest()
        {
            string id = default!;
            Client.Option<Guid> xTraceId = default!;
            var response = await _instance.GetUserAsync(id, xTraceId);
            var model = response.Ok();
            Assert.IsType<UserSingle>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListUserAsyncTest()
        {
            Client.Option<Guid> xTraceId = default!;
            Client.Option<int> limit = default!;
            Client.Option<int> page = default!;
            var response = await _instance.ListUserAsync(xTraceId, limit, page);
            var model = response.Ok();
            Assert.IsType<UserArray>(model);
        }
        ...
        public async Task StoreUserAsyncTest()
        {
            User user = default!;
            Client.Option<Guid> xTraceId = default!;
            var response = await _instance.StoreUserAsync(user, xTraceId);
        ...
        public async Task UpdateUserAsyncTest()
        {
            ...
            User user = default!;
            Client.Option<Guid> xTraceId = default!;
            var response = await _instance.UpdateUserAsync(id, user, xTraceId);
            var model = response.Ok();
            Assert.IsType<UserSingle>(model);
        }
    }
