...
namespace Brotal.FireflyIII.Model
{
    ...
    /// TagModelStore
    /// </summary>
    public partial class TagModelStore : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public TagModelStore(string tag, Option<DateOnly?> date = default, Option<string?> description = default, Option<double?> latitude = default, Option<double?> longitude = default, Option<int?> zoomLevel = default)
        {
            Tag = tag;
            DateOption = date;
    ...
    /// <summary>
    /// A Json converter for type <see cref="TagModelStore" />
    /// </summary>
    public class TagModelStoreJsonConverter : JsonConverter<TagModelStore>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TagModelStore" />
        /// </summary>
        ...
        public override TagModelStore Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!tag.IsSet)
                throw new ArgumentException("Property is required for class TagModelStore.", nameof(tag));

            if (tag.IsSet && tag.Value == null)
                throw new ArgumentNullException(nameof(tag), "Property is not nullable for class TagModelStore.");

            return new TagModelStore(tag.Value!, date, description, latitude, longitude, zoomLevel);
        }

        /// <summary>
        /// Serializes a <see cref="TagModelStore" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="tagModelStore"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TagModelStore tagModelStore, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, tagModelStore, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TagModelStore" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="tagModelStore"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TagModelStore tagModelStore, JsonSerializerOptions jsonSerializerOptions)
        {
            if (tagModelStore.Tag == null)
                throw new ArgumentNullException(nameof(tagModelStore.Tag), "Property is required for class TagModelStore.");

            writer.WriteString("tag", tagModelStore.Tag);

            if (tagModelStore.DateOption.IsSet)
                if (tagModelStore.DateOption.Value != null)
                    writer.WriteString("date", tagModelStore.DateOption.Value!.Value.ToString(DateFormat));
                else
                    writer.WriteNull("date");

            if (tagModelStore.DescriptionOption.IsSet)
                if (tagModelStore.DescriptionOption.Value != null)
                    writer.WriteString("description", tagModelStore.Description);
                else
                    writer.WriteNull("description");

            if (tagModelStore.LatitudeOption.IsSet)
                if (tagModelStore.LatitudeOption.Value != null)
                    writer.WriteNumber("latitude", tagModelStore.LatitudeOption.Value!.Value);
                else
                    writer.WriteNull("latitude");

            if (tagModelStore.LongitudeOption.IsSet)
                if (tagModelStore.LongitudeOption.Value != null)
                    writer.WriteNumber("longitude", tagModelStore.LongitudeOption.Value!.Value);
                else
                    writer.WriteNull("longitude");

            if (tagModelStore.ZoomLevelOption.IsSet)
                if (tagModelStore.ZoomLevelOption.Value != null)
                    writer.WriteNumber("zoom_level", tagModelStore.ZoomLevelOption.Value!.Value);
                else
