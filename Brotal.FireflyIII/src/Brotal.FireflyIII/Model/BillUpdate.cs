...
namespace Brotal.FireflyIII.Model
{
    ...
    /// BillUpdate
    /// </summary>
    public partial class BillUpdate : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public BillUpdate(string name, Option<string?> currencyId = default, Option<string?> currencyCode = default, Option<string?> amountMin = default, Option<string?> amountMax = default, Option<DateTime?> date = default, Option<DateTime?> endDate = default, Option<DateTime?> extensionDate = default, Option<BillRepeatFrequency?> repeatFreq = default, Option<int?> skip = default, Option<bool?> active = default, Option<string?> notes = default, Option<string?> objectGroupId = default, Option<string?> objectGroupTitle = default)
        {
            Name = name;
    ...
    /// <summary>
    /// A Json converter for type <see cref="BillUpdate" />
    /// </summary>
    public class BillUpdateJsonConverter : JsonConverter<BillUpdate>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="BillUpdate" />
        /// </summary>
        ...
        public override BillUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class BillUpdate.", nameof(name));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class BillUpdate.");

            if (currencyId.IsSet && currencyId.Value == null)
                throw new ArgumentNullException(nameof(currencyId), "Property is not nullable for class BillUpdate.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class BillUpdate.");

            if (amountMin.IsSet && amountMin.Value == null)
                throw new ArgumentNullException(nameof(amountMin), "Property is not nullable for class BillUpdate.");

            if (amountMax.IsSet && amountMax.Value == null)
                throw new ArgumentNullException(nameof(amountMax), "Property is not nullable for class BillUpdate.");

            if (date.IsSet && date.Value == null)
                throw new ArgumentNullException(nameof(date), "Property is not nullable for class BillUpdate.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class BillUpdate.");

            if (extensionDate.IsSet && extensionDate.Value == null)
                throw new ArgumentNullException(nameof(extensionDate), "Property is not nullable for class BillUpdate.");

            if (repeatFreq.IsSet && repeatFreq.Value == null)
                throw new ArgumentNullException(nameof(repeatFreq), "Property is not nullable for class BillUpdate.");

            if (skip.IsSet && skip.Value == null)
                throw new ArgumentNullException(nameof(skip), "Property is not nullable for class BillUpdate.");

            if (active.IsSet && active.Value == null)
                throw new ArgumentNullException(nameof(active), "Property is not nullable for class BillUpdate.");

            return new BillUpdate(name.Value!, currencyId, currencyCode, amountMin, amountMax, date, endDate, extensionDate, repeatFreq, skip, active, notes, objectGroupId, objectGroupTitle);
        }

        /// <summary>
        /// Serializes a <see cref="BillUpdate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="billUpdate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BillUpdate billUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, billUpdate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BillUpdate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="billUpdate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BillUpdate billUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (billUpdate.Name == null)
                throw new ArgumentNullException(nameof(billUpdate.Name), "Property is required for class BillUpdate.");

            if (billUpdate.CurrencyIdOption.IsSet && billUpdate.CurrencyId == null)
                throw new ArgumentNullException(nameof(billUpdate.CurrencyId), "Property is required for class BillUpdate.");

            if (billUpdate.CurrencyCodeOption.IsSet && billUpdate.CurrencyCode == null)
                throw new ArgumentNullException(nameof(billUpdate.CurrencyCode), "Property is required for class BillUpdate.");

            if (billUpdate.AmountMinOption.IsSet && billUpdate.AmountMin == null)
                throw new ArgumentNullException(nameof(billUpdate.AmountMin), "Property is required for class BillUpdate.");

            if (billUpdate.AmountMaxOption.IsSet && billUpdate.AmountMax == null)
                throw new ArgumentNullException(nameof(billUpdate.AmountMax), "Property is required for class BillUpdate.");

            writer.WriteString("name", billUpdate.Name);

            if (billUpdate.CurrencyIdOption.IsSet)
                writer.WriteString("currency_id", billUpdate.CurrencyId);

            if (billUpdate.CurrencyCodeOption.IsSet)
                writer.WriteString("currency_code", billUpdate.CurrencyCode);

            if (billUpdate.AmountMinOption.IsSet)
                writer.WriteString("amount_min", billUpdate.AmountMin);

            if (billUpdate.AmountMaxOption.IsSet)
                writer.WriteString("amount_max", billUpdate.AmountMax);

            if (billUpdate.DateOption.IsSet)
                writer.WriteString("date", billUpdate.DateOption.Value!.Value.ToString(DateFormat));

            if (billUpdate.EndDateOption.IsSet)
                writer.WriteString("end_date", billUpdate.EndDateOption.Value!.Value.ToString(EndDateFormat));

            if (billUpdate.ExtensionDateOption.IsSet)
                writer.WriteString("extension_date", billUpdate.ExtensionDateOption.Value!.Value.ToString(ExtensionDateFormat));

            if (billUpdate.RepeatFreqOption.IsSet)
            {
                var repeatFreqRawValue = BillRepeatFrequencyValueConverter.ToJsonValue(billUpdate.RepeatFreq!.Value);
                writer.WriteString("repeat_freq", repeatFreqRawValue);
            }
            if (billUpdate.SkipOption.IsSet)
                writer.WriteNumber("skip", billUpdate.SkipOption.Value!.Value);

            if (billUpdate.ActiveOption.IsSet)
                writer.WriteBoolean("active", billUpdate.ActiveOption.Value!.Value);

            if (billUpdate.NotesOption.IsSet)
                if (billUpdate.NotesOption.Value != null)
                    writer.WriteString("notes", billUpdate.Notes);
                else
                    writer.WriteNull("notes");

            if (billUpdate.ObjectGroupIdOption.IsSet)
                if (billUpdate.ObjectGroupIdOption.Value != null)
                    writer.WriteString("object_group_id", billUpdate.ObjectGroupId);
                else
                    writer.WriteNull("object_group_id");

            if (billUpdate.ObjectGroupTitleOption.IsSet)
                if (billUpdate.ObjectGroupTitleOption.Value != null)
                    writer.WriteString("object_group_title", billUpdate.ObjectGroupTitle);
                else
