...
namespace Brotal.FireflyIII.Model
{
    ...
    public partial class BadRequestResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public BadRequestResponse(Option<string?> message = default, Option<string?> exception = default)
        {
    ...
    public class BadRequestResponseJsonConverter : JsonConverter<BadRequestResponse>
    {
        ...
        public override BadRequestResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class BadRequestResponse.");

            if (exception.IsSet && exception.Value == null)
                throw new ArgumentNullException(nameof(exception), "Property is not nullable for class BadRequestResponse.");

            return new BadRequestResponse(message, exception);
        }
        ...
        {
            if (badRequestResponse.MessageOption.IsSet && badRequestResponse.Message == null)
                throw new ArgumentNullException(nameof(badRequestResponse.Message), "Property is required for class BadRequestResponse.");

            if (badRequestResponse.ExceptionOption.IsSet && badRequestResponse.Exception == null)
                throw new ArgumentNullException(nameof(badRequestResponse.Exception), "Property is required for class BadRequestResponse.");

            if (badRequestResponse.MessageOption.IsSet)
                writer.WriteString("message", badRequestResponse.Message);

            if (badRequestResponse.ExceptionOption.IsSet)
                writer.WriteString("exception", badRequestResponse.Exception);
        }
    }
}
