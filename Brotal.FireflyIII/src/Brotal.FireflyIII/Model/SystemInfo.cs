...
namespace Brotal.FireflyIII.Model
{
    ...
    public partial class SystemInfo : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SystemInfo(Option<SystemInfoData?> data = default)
        {
            DataOption = data;
            OnCreated();
        }
        ...
        public Option<SystemInfoData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public SystemInfoData? Data { get { return this.DataOption; } set { this.DataOption = new(value); } }
    ...
    public class SystemInfoJsonConverter : JsonConverter<SystemInfo>
    {
        ...
        public override SystemInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SystemInfoData?> data = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<SystemInfoData?>(JsonSerializer.Deserialize<SystemInfoData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SystemInfo.");
        ...
        {
            if (systemInfo.DataOption.IsSet && systemInfo.Data == null)
                throw new ArgumentNullException(nameof(systemInfo.Data), "Property is required for class SystemInfo.");

            if (systemInfo.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, systemInfo.Data, jsonSerializerOptions);
            }
        }
    }
}
