...
namespace Brotal.FireflyIII.Model
{
    ...
    public partial class NotFoundResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public NotFoundResponse(Option<string?> message = default, Option<string?> exception = default)
        {
    ...
    public class NotFoundResponseJsonConverter : JsonConverter<NotFoundResponse>
    {
        ...
        public override NotFoundResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class NotFoundResponse.");

            if (exception.IsSet && exception.Value == null)
                throw new ArgumentNullException(nameof(exception), "Property is not nullable for class NotFoundResponse.");

            return new NotFoundResponse(message, exception);
        }
        ...
        {
            if (notFoundResponse.MessageOption.IsSet && notFoundResponse.Message == null)
                throw new ArgumentNullException(nameof(notFoundResponse.Message), "Property is required for class NotFoundResponse.");

            if (notFoundResponse.ExceptionOption.IsSet && notFoundResponse.Exception == null)
                throw new ArgumentNullException(nameof(notFoundResponse.Exception), "Property is required for class NotFoundResponse.");

            if (notFoundResponse.MessageOption.IsSet)
                writer.WriteString("message", notFoundResponse.Message);

            if (notFoundResponse.ExceptionOption.IsSet)
                writer.WriteString("exception", notFoundResponse.Exception);
        }
    }
}
